...
option3 = st.sidebar.selectbox(
    'Select number of customers to analyze',
...
st.subheader('Relation between Bills and Payments in Consecutive Months')
st.write('First ' + str(option3) +' Customers')
chartdata1 = pd.DataFrame(data[:option3],columns=['BILL_AMT1','PAY_AMT1'])
st.area_chart(chartdata1)

chartdata1 = pd.DataFrame(data[:option3],columns=['BILL_AMT2','PAY_AMT2'])
st.area_chart(chartdata1)

chartdata1 = pd.DataFrame(data[:option3],columns=['BILL_AMT3','PAY_AMT3'])
st.area_chart(chartdata1)

chartdata1 = pd.DataFrame(data[:option3],columns=['BILL_AMT4','PAY_AMT4'])
st.area_chart(chartdata1)

chartdata1 = pd.DataFrame(data[:option3],columns=['BILL_AMT5','PAY_AMT5'])
st.area_chart(chartdata1)
